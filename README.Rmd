...
Calculating PCBrainAge is very simple to do using our function. You can either output it to your own vector, or you can append a column to an existing phenotype dataframe. We assume that:
1. your methylation data is in the form of samples as rows, CpGs as columns 
2. the sample DNAm dataframe rows match the sample order in the pheno dataframe, if you have such a dataframe available.
